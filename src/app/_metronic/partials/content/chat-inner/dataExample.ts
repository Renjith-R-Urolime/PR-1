...
const defaultMessages: Array<MessageModel> = [
  ...
  },
  {
    user: 4,
    type: 'in',
    text: 'You can unwatch this repository immediately by clicking here: <a href="https://keenthemes.com">Infithra.com</a>',
    time: '3 Hours',
  },
  {
    user: 2,
...
const defaultUserInfos: Array<UserInfoModel> = [
  ...
  {
    name: 'Robert Doe',
    initials: { label: 'A', state: 'primary' },
...
export {
    MessageModel, UserInfoModel, defaultMessages, defaultUserInfos,
    messageFromClient
};
